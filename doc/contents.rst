...
- A `PDF <../latex/astk.pdf>`_ version of |astk| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:alinea:astk:astk>`__ wiki.
