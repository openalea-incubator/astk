...
# * name is the full name (e.g., Alinea.astk) whereas pkg_name is only 'astk'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['astk = alinea.astk_wralea' if has_project else 'astk = astk_wralea' ],
        #'console_scripts': [
