...
def test_twilight():
    sky_irr = sky_irradiance(ghi=1.0, dates=pandas.Timestamp('2017-08-17 19:00:00+0400', tz='Indian/Reunion'), latitude=-21.32,
                    longitude=55.5, timezone='Indian/Reunion')
    assert sky_irr.dhi.sum() == 1
    assert sky_irr.dni.sum() == 0